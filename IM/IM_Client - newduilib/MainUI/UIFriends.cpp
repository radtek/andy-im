            ...
            if( pListItem != NULL )
			{
				...
				if ((pFriendListItem != NULL) && (node != NULL) && !node->folder())
				{
					...
					if (log_button != NULL)
					{
						...
						if (logo_container != NULL)
						{
							logo_container->SetPadding(CDuiRect(0,0,0,0));
							log_button->SetPadding(CDuiRect(0,0,0,0));
		...
		if ((pFriendListItem != NULL) && (node != NULL) && !node->folder())
		{
			...
			if (log_button != NULL)
			{
					...
					if (logo_container != NULL)
					{
						...
						logo_container->SetPadding(CDuiRect(0,5,0,0));
						log_button->SetPadding(CDuiRect(0,5,0,0));
						//大小
